...
{
    internal class VideoItemHelper
    {
        internal static string cull(string strSource, string strStart, string strEnd)
        {
            int Start, End;
            ...
            if (strSource.Contains(strStart) && strSource.Contains(strEnd))
            {
                ...
                return WebUtility.HtmlDecode(strSource.Substring(Start, val));
            }
            else
            {
                return "";
